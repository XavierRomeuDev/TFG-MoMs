...
<body>
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between mb-3 mt-4">
            ...
            <a href="{{ route('dashboard.partners.create', ['lang' => app()->getLocale()]) }}"
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($partners as $partner)
                        <tr>
                            <td class="name">{{ utf8_encode($partner->name) }}</td>
                            <td>{{ $partner->id }}</td>
                            <td class="options">
                                ...
                                <form action="{{ route('dashboard.partners.destroy', ['lang' => app()->getLocale(), 'partner' => $partner->id]) }}" method="POST">
                                    <a class="btn btn-primary"
                                        href="{{ route('dashboard.partners.edit', ['lang' => app()->getLocale(), 'partner' => $partner->id]) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')
